...
class PonudjaciResourceIT {
    ...
    @Test
    @Transactional
    void getAllPonudjacisByNazivPonudjacaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ponudjaciRepository.saveAndFlush(ponudjaci);

        // Get all the ponudjaciList where nazivPonudjaca not equals to DEFAULT_NAZIV_PONUDJACA
        defaultPonudjaciShouldNotBeFound("nazivPonudjaca.notEquals=" + DEFAULT_NAZIV_PONUDJACA);

        // Get all the ponudjaciList where nazivPonudjaca not equals to UPDATED_NAZIV_PONUDJACA
        defaultPonudjaciShouldBeFound("nazivPonudjaca.notEquals=" + UPDATED_NAZIV_PONUDJACA);
    }
    ...
    @Test
    @Transactional
    void getAllPonudjacisByOdgovornoLiceIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ponudjaciRepository.saveAndFlush(ponudjaci);

        // Get all the ponudjaciList where odgovornoLice not equals to DEFAULT_ODGOVORNO_LICE
        defaultPonudjaciShouldNotBeFound("odgovornoLice.notEquals=" + DEFAULT_ODGOVORNO_LICE);

        // Get all the ponudjaciList where odgovornoLice not equals to UPDATED_ODGOVORNO_LICE
        defaultPonudjaciShouldBeFound("odgovornoLice.notEquals=" + UPDATED_ODGOVORNO_LICE);
    }
    ...
    @Test
    @Transactional
    void getAllPonudjacisByAdresaPonudjacaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ponudjaciRepository.saveAndFlush(ponudjaci);

        // Get all the ponudjaciList where adresaPonudjaca not equals to DEFAULT_ADRESA_PONUDJACA
        defaultPonudjaciShouldNotBeFound("adresaPonudjaca.notEquals=" + DEFAULT_ADRESA_PONUDJACA);

        // Get all the ponudjaciList where adresaPonudjaca not equals to UPDATED_ADRESA_PONUDJACA
        defaultPonudjaciShouldBeFound("adresaPonudjaca.notEquals=" + UPDATED_ADRESA_PONUDJACA);
    }
    ...
    @Test
    @Transactional
    void getAllPonudjacisByBankaRacunIsNotEqualToSomething() throws Exception {
        // Initialize the database
        ponudjaciRepository.saveAndFlush(ponudjaci);

        // Get all the ponudjaciList where bankaRacun not equals to DEFAULT_BANKA_RACUN
        defaultPonudjaciShouldNotBeFound("bankaRacun.notEquals=" + DEFAULT_BANKA_RACUN);

        // Get all the ponudjaciList where bankaRacun not equals to UPDATED_BANKA_RACUN
        defaultPonudjaciShouldBeFound("bankaRacun.notEquals=" + UPDATED_BANKA_RACUN);
    }
    ...
    @Test
    @Transactional
    void getAllPonudjacisByPonudeIsEqualToSomething() throws Exception {
        // Initialize the database
        ponudjaciRepository.saveAndFlush(ponudjaci);
        Ponude ponude;
        ...
        em.persist(ponude);
        em.flush();
        ponudjaci.addPonude(ponude);
        ponudjaciRepository.saveAndFlush(ponudjaci);
        Long ponudeId = ponude.getId();

        // Get all the ponudjaciList where ponude equals to ponudeId
        defaultPonudjaciShouldBeFound("ponudeId.equals=" + ponudeId);

        // Get all the ponudjaciList where ponude equals to (ponudeId + 1)
        defaultPonudjaciShouldNotBeFound("ponudeId.equals=" + (ponudeId + 1));
    }
