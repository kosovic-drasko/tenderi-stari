...
class PostupciResourceIT {
    ...
    @Test
    @Transactional
    void getAllPostupcisByBrojTenderaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        postupciRepository.saveAndFlush(postupci);

        // Get all the postupciList where brojTendera not equals to DEFAULT_BROJ_TENDERA
        defaultPostupciShouldNotBeFound("brojTendera.notEquals=" + DEFAULT_BROJ_TENDERA);

        // Get all the postupciList where brojTendera not equals to UPDATED_BROJ_TENDERA
        defaultPostupciShouldBeFound("brojTendera.notEquals=" + UPDATED_BROJ_TENDERA);
    }
    ...
    @Test
    @Transactional
    void getAllPostupcisByOpisPostupkaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        postupciRepository.saveAndFlush(postupci);

        // Get all the postupciList where opisPostupka not equals to DEFAULT_OPIS_POSTUPKA
        defaultPostupciShouldNotBeFound("opisPostupka.notEquals=" + DEFAULT_OPIS_POSTUPKA);

        // Get all the postupciList where opisPostupka not equals to UPDATED_OPIS_POSTUPKA
        defaultPostupciShouldBeFound("opisPostupka.notEquals=" + UPDATED_OPIS_POSTUPKA);
    }
    ...
    @Test
    @Transactional
    void getAllPostupcisByVrstaPostupkaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        postupciRepository.saveAndFlush(postupci);

        // Get all the postupciList where vrstaPostupka not equals to DEFAULT_VRSTA_POSTUPKA
        defaultPostupciShouldNotBeFound("vrstaPostupka.notEquals=" + DEFAULT_VRSTA_POSTUPKA);

        // Get all the postupciList where vrstaPostupka not equals to UPDATED_VRSTA_POSTUPKA
        defaultPostupciShouldBeFound("vrstaPostupka.notEquals=" + UPDATED_VRSTA_POSTUPKA);
    }
    ...
    @Test
    @Transactional
    void getAllPostupcisByDatumObjaveIsNotEqualToSomething() throws Exception {
        // Initialize the database
        postupciRepository.saveAndFlush(postupci);

        // Get all the postupciList where datumObjave not equals to DEFAULT_DATUM_OBJAVE
        defaultPostupciShouldNotBeFound("datumObjave.notEquals=" + DEFAULT_DATUM_OBJAVE);

        // Get all the postupciList where datumObjave not equals to UPDATED_DATUM_OBJAVE
        defaultPostupciShouldBeFound("datumObjave.notEquals=" + UPDATED_DATUM_OBJAVE);
    }
    ...
    @Test
    @Transactional
    void getAllPostupcisByDatumOtvaranjaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        postupciRepository.saveAndFlush(postupci);

        // Get all the postupciList where datumOtvaranja not equals to DEFAULT_DATUM_OTVARANJA
        defaultPostupciShouldNotBeFound("datumOtvaranja.notEquals=" + DEFAULT_DATUM_OTVARANJA);

        // Get all the postupciList where datumOtvaranja not equals to UPDATED_DATUM_OTVARANJA
        defaultPostupciShouldBeFound("datumOtvaranja.notEquals=" + UPDATED_DATUM_OTVARANJA);
    }
    ...
    @Test
    @Transactional
    void getAllPostupcisByKriterijumCijenaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        postupciRepository.saveAndFlush(postupci);

        // Get all the postupciList where kriterijumCijena not equals to DEFAULT_KRITERIJUM_CIJENA
        defaultPostupciShouldNotBeFound("kriterijumCijena.notEquals=" + DEFAULT_KRITERIJUM_CIJENA);

        // Get all the postupciList where kriterijumCijena not equals to UPDATED_KRITERIJUM_CIJENA
        defaultPostupciShouldBeFound("kriterijumCijena.notEquals=" + UPDATED_KRITERIJUM_CIJENA);
    }
    ...
    @Test
    @Transactional
    void getAllPostupcisByDrugiKriterijumIsNotEqualToSomething() throws Exception {
        // Initialize the database
        postupciRepository.saveAndFlush(postupci);

        // Get all the postupciList where drugiKriterijum not equals to DEFAULT_DRUGI_KRITERIJUM
        defaultPostupciShouldNotBeFound("drugiKriterijum.notEquals=" + DEFAULT_DRUGI_KRITERIJUM);

        // Get all the postupciList where drugiKriterijum not equals to UPDATED_DRUGI_KRITERIJUM
        defaultPostupciShouldBeFound("drugiKriterijum.notEquals=" + UPDATED_DRUGI_KRITERIJUM);
    }
