...
public class PonudeResource {
     ...
     *         body the new ponude, or with status {@code 400 (Bad Request)} if the
     *         ponude has already an ID.
     ...
     *         or with status {@code 500 (Internal Server Error)} if the ponude
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    /**
     * {@code PATCH  /ponudes/:id} : Partial updates given fields of an existing
     * ponude, field will ignore if it is null
     *
     * @param id     the id of the ponude to save.
     * @param ponude the ponude to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the ponude, or with status {@code 404 (Not Found)}.
     */
