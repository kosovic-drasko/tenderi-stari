...
import static tender.constants.ApplicationConstants.*;
...
public class VideoStreamService {
    ...
    public Long getFileSize(String fileName) {
        return Optional.ofNullable(fileName).map(file -> Paths.get(getFilePath(), file)).map(this::sizeFromFile).orElse(0L);
    }
